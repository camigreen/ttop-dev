...
class JMapControllerSitemap extends JMapController {
	...
	public function display($cachable = false, $urlparams = false) {
		...
		$precachedSitemapFileName = JPATH_COMPONENT . '/precache/sitemap_' . $format . $langString . $ItemidFilter . '.xml';
	...
	public function exportXML() {
		...
		if ($cParams->get ( 'split_sitemap', false ) && !$jsClient) {
			// Split the sitemap
			...
			$pathForFile = JPATH_COMPONENT_ADMINISTRATOR . '/cache/analyzer/sitemap_' . $format . $langString . $ItemidFilter . '.xml';
	...
	public function doPreCaching() {
		...
		$preCacher = new JMapXmlPrecacher('sitemap_' . $format . $langString . $ItemidFilter . '.xml', $fileStreamWriter);
