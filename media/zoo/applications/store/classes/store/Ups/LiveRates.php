    ...
    public function get_rate($packages = array())
    {
        ...
        foreach($packages as $package)
        {
        	...
        	$width	 = isset($package->width)  ? $package->width  : 0;
                $insurance = isset($package->insurance) ? $package->insurance : 0;
                ...
                <Package>
                    ...
                    <PackageServiceOptions>
                        <InsuredValue>
                            ...
                            <MonetaryValue>$insurance</MonetaryValue>
                        </InsuredValue>
                    </PackageServiceOptions>
                </Package>
            ";	        
        ...
        $result = $this->curl($this->endpoint, $data);
...
class Ups_Live_Rates_Response extends Ups_BaseResponse{
