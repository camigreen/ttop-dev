...
<div class="uk-margin">
	...
	<div class="more-options">
		...
		<div class="advanced options">
			...
			<div class="uk-margin row">
				<strong><?php echo JText::_('New windowfgghfghfgh'); ?></strong>
				<?php echo $this->app->html->_('select.booleanlist', $this->getControlName('target'), '', $this->get('target', $this->config->get('default_target'))) ?>
			</div>
                    
                        <div class="uk-margin row">
                                <p> test </p>
				<strong><?php echo JText::_('Button or Link'); ?></strong>
				<?php echo $this->app->html->_('select.radiolist', array('b' => 'Button','l' => 'Link'), $this->getControlName('type'), '') ?>
			</div>
