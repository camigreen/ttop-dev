...
<div class="uk-margin-top">
    <button id="atc-<?php echo $item_id; ?>" class="uk-button uk-button-danger atc"><i class="uk-icon-shopping-cart" data-store-cart style="margin-right:5px;"></i>Add to Cart</button>
</div>
