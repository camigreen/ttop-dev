...
(function($){
    ...
    $.extend(Plugin.prototype,{
        ...
        initialize:function(element,options){
            ...
            element.delegate("div.delete","click",function(){
                $(this).parent("li").slideUp(400,function(){
                    $(this).remove();
                    $this.orderOptions()
                    })
        ...
        $this.hidden.clone().removeClass("hidden").appendTo($this.list).slideDown(200).effect("highlight",{},1e3).find("input:first").focus();
        $this.orderOptions()
        });
    this.list.sortable({
