			...
			<tr>
				...
				<td class="paramlist_value">
					...
					<div id="controls_grouper">
						<button data-role="priority_action" data-action="store" class="btn btn-xs btn-primary active"><span class="glyphicon glyphicon-floppy-disk"></span><?php echo JText::_('COM_JMAP_ASSIGN_MENU_PRIORITIES_BTN');?></button>
						<button data-role="priority_action" data-action="remove" class="btn btn-xs btn-default active"><span class="glyphicon glyphicon-remove"></span><?php echo JText::_('COM_JMAP_REMOVE_MENU_PRIORITIES_BTN');?></button>
					</div>
				</td>
			</tr>
		</table>
