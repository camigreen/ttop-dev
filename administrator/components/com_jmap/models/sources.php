...
class JMapModelSources extends JMapModel implements IJMapModelSources {
	...
	public function getLists($record = null) {
		...
		if($record->type == 'menu') {
			...
			$lists['menu_priorities']	= JHTML::_('select.genericlist', $selectionsWithPriority, 'params[menu_priorities]', array('option.attr'=>'style', 'list.attr'=>'class="inputbox" size="15"'));
		}
