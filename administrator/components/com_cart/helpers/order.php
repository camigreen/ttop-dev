...
class OrderHelper extends AppHelper {
	 ...
	 * @since 2.0
	 */
	public function getOrderHash($submission_id, $type_id, $item_id = 0, $edit = false) {
	 ...
	 * @since 3.2
	 */
	public function getOrderEditParams(array $types) {
 ...
 */
class OrderHelperException extends AppException {}